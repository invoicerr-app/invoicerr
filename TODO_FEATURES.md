...
| # | Rang | Feature | État |
|---|---|---|---|
| 1 | 3 | Portail client authentifié | ✅ **livré** (`fddfc7df`) |
| 2 | 11 | Suivi du temps & facturation de projets | ✅ **livré** (`fddfc7df`) |
| 3 | 14 | Langue du document par destinataire | 🔵 en cours |
