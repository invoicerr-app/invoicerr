...
## Remaining (3) — verified in the code on 2026-09-15, 14:00

| Rank | Feature | Verified state (2026-09-15) | e2e to prove |
|---:|---|---|---|
| P | Profile page — move it out of Settings and make it work | **Owner request, 2026-09-15 evening**: Settings is company-scoped, the user profile does not belong there — it moves to its own user-level page (reached from the account menu), and editing the user's own information "works so-so" today. First step: an agent audits the current page (what it edits, which routes, what fails), then a redesign proposal to validate before building. Not started. | A user edits name/email/password/avatar from the new page, sees the change without reloading, and Settings no longer shows a profile section. |
