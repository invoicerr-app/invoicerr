...
- **E (hosted subscription)** — **SETTLED** on 2026-09-15, not to be reopened: platform (Polar
  Starter), graduated model (first seat $15, seats 2–4 $5 each, from the 5th seat $4 each, yearly
  ×12 (no discount decided) — set in the Polar sandbox on 2026-09-15), billing period (monthly AND
  annual), definition of a seat (`UserCompany`, OWNER included, invitation counted only on
  acceptance), full lifecycle in both cases (never paid: 7-day trial with no `'send'` → blocked 14
