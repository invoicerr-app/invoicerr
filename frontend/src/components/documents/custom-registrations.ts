 ...
 * mechanism this feeds, and custom/invoice-correction-routes-button.tsx for a real extension).
 *
 ...
 * the registry (document-list.tsx, document-detail.tsx) only ever asks "is anything registered for (typeId, slot)",
