...
/**
 * `retentionCalcVersion` is the discriminator `TODO_ISSUES.md`'s "les archives déjà écrites gardent
 * une date de conservation trop précoce" (2026-09-13) entry asked for: NULL on any row written before
