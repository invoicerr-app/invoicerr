 ...
 */
export function TableSearchFilter({ label, options, value, onValueChange, onSearchChange, placeholder, noResultsText, dataCy }: TableSearchFilterProps) {
    return (
        <div className="flex flex-col gap-2 min-w-[220px]">
            ...
            <div className="flex items-center gap-1">
                ...
                />
                {value && (
                    <Button type="button" variant="ghost" size="icon" className="shrink-0" onClick={() => onValueChange(undefined)}>
                        <X className="h-4 w-4" />
                    </Button>
                )}
            </div>
 ...
 */
export function TableFilterBar({ translationPrefix, year, onYearChange, month, onMonthChange, onExport, exportDisabled, children }: TableFilterBarProps) {
    ...
    return (
        <div className="flex flex-wrap items-end gap-3">
            ...
            <Button type="button" variant="outline" size="sm" onClick={onExport} disabled={exportDisabled} className="ml-auto">
