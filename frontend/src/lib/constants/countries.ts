// ISO 3166-1 alpha-2 country codes. Labels are resolved at runtime via Intl.DisplayNames
// so they stay localized without needing a translation entry per country per language.
