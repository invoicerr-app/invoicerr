...
export default function AccountSettings() {
  ...
  const profileSchema = z
    ...
    .refine(
      (data) => data.firstname.trim() !== "" && data.lastname.trim() !== "" && data.email.trim() !== "",
      {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          type="email"
                          placeholder={t("settings.account.form.email.placeholder")}
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
        ...
        <Card className="h-fit">
          <CardHeader>
            ...
            <CardDescription>
              {t(
                "settings.account.language.description",
                "Choose the language of the interface. Languages marked (beta) are partially or machine translated.",
              )}
            </CardDescription>
          </CardHeader>
          <CardContent>
