...
export default function AccountSettings() {
  ...
  const profileSchema = z
    .object({
      firstname: z
        .string()
        .min(1, { message: t('settings.account.form.firstname.errors.required') }),
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder={t('settings.account.form.firstname.placeholder')}
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder={t('settings.account.form.lastname.placeholder')}
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
