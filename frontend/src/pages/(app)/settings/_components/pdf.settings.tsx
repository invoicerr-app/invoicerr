...
/** Mirrors the backend's item description formatting for an accurate preview. */
function formatItemDescription(text?: string | null): string {
  if (!text) return ""
      ...
      items: [
        {
          ...
          description: formatItemDescription(
            "**Frontend and backend** implementation, including *code review*.",
          ),
          type: "Hour",
          quantity: "40",
          unitPrice: "75.00",
