                ...
                <div className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        {t('settings.pdfTemplates.templateType.description')}
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-2">
                        <Label htmlFor="template-type">
                          {t('settings.pdfTemplates.templateType.label')}
                        </Label>
                        <Select
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        {t('settings.pdfTemplates.typography.description')}
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-2">
                        <Label htmlFor="font-family">
                          {t('settings.pdfTemplates.typography.fontFamily')}
                        </Label>
                        <Select
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        {t('settings.pdfTemplates.colors.description')}
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        <Label htmlFor="primary-color">
                          {t('settings.pdfTemplates.colors.primaryColor')}
                        </Label>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="primary-color">
                          {t('settings.pdfTemplates.colors.secondaryColor')}
                        </Label>
                        <div className="flex items-center space-x-2">
                          <input
                            type="color"
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        {t('settings.pdfTemplates.logo.description')}
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="flex items-center space-x-2">
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setSettings((prev) => ({ ...prev, includeLogo: checked }))
                          }
                        />
                        <Label htmlFor="include-logo">
                          {t('settings.pdfTemplates.logo.includeLogo')}
                        </Label>
                      </div>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        {t('settings.pdfTemplates.spacing.description')}
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-1 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="label-invoice">
                            {t('settings.pdfTemplates.labels.invoice')}
                          </Label>
                          <Input
                            id="label-invoice"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-quote">
                            {t('settings.pdfTemplates.labels.quote')}
                          </Label>
                          <Input
                            id="label-quote"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-legal-id">
                            {t('settings.pdfTemplates.labels.legalId')}
                          </Label>
                          <Input
                            id="label-legal-id"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-vat-id">
                            {t('settings.pdfTemplates.labels.vatId')}
                          </Label>
                          <Input
                            id="label-vat-id"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-bill-to">
                            {t('settings.pdfTemplates.labels.billTo')}
                          </Label>
                          <Input
                            id="label-bill-to"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-quote-for">
                            {t('settings.pdfTemplates.labels.quoteFor')}
                          </Label>
                          <Input
                            id="label-quote-for"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-valid-until">
                            {t('settings.pdfTemplates.labels.validUntil')}
                          </Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-due-date">
                            {t('settings.pdfTemplates.labels.dueDate')}
                          </Label>
                          <Input
                            id="label-due-date"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-date">
                            {t('settings.pdfTemplates.labels.date')}
                          </Label>
                          <Input
                            id="label-date"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-description">
                            {t('settings.pdfTemplates.labels.description')}
                          </Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-quantity">
                            {t('settings.pdfTemplates.labels.quantity')}
                          </Label>
                          <Input
                            id="label-quantity"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-unit-price">
                            {t('settings.pdfTemplates.labels.unitPrice')}
                          </Label>
                          <Input
                            id="label-unit-price"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-total">
                            {t('settings.pdfTemplates.labels.total')}
                          </Label>
                          <Input
                            id="label-total"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-subtotal">
                            {t('settings.pdfTemplates.labels.subtotal')}
                          </Label>
                          <Input
                            id="label-subtotal"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-vat-rate">
                            {t('settings.pdfTemplates.labels.vatRate')}
                          </Label>
                          <Input
                            id="label-vat-rate"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-grand-total">
                            {t('settings.pdfTemplates.labels.grandTotal')}
                          </Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-payment-method">
                            {t('settings.pdfTemplates.labels.paymentMethod')}
                          </Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-payment-details">
                            {t('settings.pdfTemplates.labels.paymentDetails')}
                          </Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-notes">
                            {t('settings.pdfTemplates.labels.notes')}
                          </Label>
                          <Input
                            id="label-notes"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-type">
                            {t('settings.pdfTemplates.labels.type')}
                          </Label>
                          <Input
                            id="label-type"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-hour">
                            {t('settings.pdfTemplates.labels.hour')}
                          </Label>
                          <Input
                            id="label-hour"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-deposit">
                            {t('settings.pdfTemplates.labels.deposit')}
                          </Label>
                          <Input
                            id="label-deposit"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-service">
                            {t('settings.pdfTemplates.labels.service')}
                          </Label>
                          <Input
                            id="label-service"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-product">
                            {t('settings.pdfTemplates.labels.product')}
                          </Label>
                          <Input
                            id="label-product"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-receipt">
                            {t('settings.pdfTemplates.labels.receipt')}
                          </Label>
                          <Input
                            id="label-receipt"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-received-from">
                            {t('settings.pdfTemplates.labels.receivedFrom')}
                          </Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-invoice-refer">
                            {t('settings.pdfTemplates.labels.invoiceRefer')}
                          </Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-payment-date">
                            {t('settings.pdfTemplates.labels.paymentDate')}
                          </Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="label-total-received">
                            {t('settings.pdfTemplates.labels.totalReceived')}
                          </Label>
                          <Input
                        ...
                        <div className="space-y-2 pt-4 border-t">
                          <h4 className="text-sm font-medium">
                            {t('settings.pdfTemplates.labels.paymentMethodVariants')}
                          </h4>
                          <div className="grid grid-cols-1 gap-2 mt-2">
                            <div className="space-y-2">
                              <Label htmlFor="label-payment-bank-transfer">
                                {t('settings.pdfTemplates.labels.paymentMethodBankTransfer')}
                              </Label>
                              <Input
                                id="label-payment-bank-transfer"
                                value={settings.labels.paymentMethodBankTransfer}
                                onChange={(e) =>
                                  updateLabel('paymentMethodBankTransfer', e.target.value)
                                }
                              />
                            </div>
                            <div className="space-y-2">
                              <Label htmlFor="label-payment-paypal">
                                {t('settings.pdfTemplates.labels.paymentMethodPayPal')}
                              </Label>
                              <Input
                            ...
                            <div className="space-y-2">
                              <Label htmlFor="label-payment-cash">
                                {t('settings.pdfTemplates.labels.paymentMethodCash')}
                              </Label>
                              <Input
                            ...
                            <div className="space-y-2">
                              <Label htmlFor="label-payment-check">
                                {t('settings.pdfTemplates.labels.paymentMethodCheck')}
                              </Label>
                              <Input
                            ...
                            <div className="space-y-2">
                              <Label htmlFor="label-payment-other">
                                {t('settings.pdfTemplates.labels.paymentMethodOther')}
                              </Label>
                              <Input
              ...
              <div className="shrink-0 p-6 pb-4 border-b">
                ...
                <p className="text-sm text-muted-foreground">
                  {t('settings.pdfTemplates.preview.description', {
                    templateType: t(
                      `settings.pdfTemplates.templateType.options.${settings.templateType}`,
                    ),
                  })}
                </p>
              </div>
