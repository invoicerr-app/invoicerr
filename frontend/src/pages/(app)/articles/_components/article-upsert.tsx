        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4" data-cy="article-form">
            ...
            {/* Basic stock management ("gestion de stock basique") — both optional, both blank by
                ...
                ("how much, and when to warn"), not more pricing facts alongside unitPrice/vatRate. */}
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <BetterInput
                        ...
                        ref={field.ref}
                        value={field.value ?? ""}
                        // Converts an emptied box to `null` right here — see `nullableNonNegativeInt`'s
                        // own comment on why that keeps this schema's input/output types identical.
                        onChange={(e) =>
