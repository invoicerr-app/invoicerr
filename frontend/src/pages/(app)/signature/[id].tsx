          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                To sign this quote, click the button below. A verification code will be sent by
                email.
              </p>
              <Button
                data-cy="send-otp-btn"
                onClick={handleSendOtp}
                disabled={optCodeloading}
                className="w-full"
              >
          ...
          <Card>
            ...
            <CardContent>
              <Alert className="mb-4">
                ...
                <AlertDescription>
                  A verification code has been sent to your email address. Please enter it below to
                  sign the quote.
                </AlertDescription>
              </Alert>
              ...
              <form onSubmit={handleSignWithOtp} className="space-y-4">
                ...
                <div className="flex gap-2">
                  <Button
                    data-cy="sign-quote-btn"
                    type="submit"
                    disabled={signingLoading || !otpCode.trim()}
                    className="flex-1"
                  >
    ...
    <div className="max-w-7xl mx-auto space-y-6 px-6 py-8">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Quote #{signature.quote.number} • Expires on{' '}
