              ...
              <FormItem>
                ...
                <FormControl>
                  <SearchSelect
                    ...
                    noResultsComponent={
                      <Button type="button" variant="link" onClick={() => setClientDialogOpen(true)}>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>{t("quotes.upsert.form.discountRate.description")}</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>{t("quotes.upsert.form.paymentMethod.description")}</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormControl>
                                  <Input
                                    {...field}
                                    placeholder={t(`quotes.upsert.form.items.name.placeholder`)}
                                  />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                              ...
                              <FormItem>
                                <FormControl>
                                  ...
                                  >
                                    <SelectTrigger
                                      className="w-32 mb-0"
                                      aria-label={t("invoices.upsert.form.items.type.label") as string}
                                    >
                                      <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                                      <SelectItem value="HOUR">
                                        {t("invoices.upsert.form.items.type.hour")}
                                      </SelectItem>
                                      <SelectItem value="DAY">
                                        {t("invoices.upsert.form.items.type.day")}
                                      </SelectItem>
                                      <SelectItem value="DEPOSIT">
                                        {t("invoices.upsert.form.items.type.deposit")}
                                      </SelectItem>
                                      <SelectItem value="SERVICE">
                                        {t("invoices.upsert.form.items.type.service")}
                                      </SelectItem>
                                      <SelectItem value="PRODUCT">
                                        {t("invoices.upsert.form.items.type.product")}
                                      </SelectItem>
                                    </SelectContent>
                                  </Select>
                                </FormControl>
                              ...
                              <FormItem>
                                <FormControl>
                                  <BetterInput
                                    ...
                                    type="number"
                                    step="0.001"
                                    placeholder={t(`quotes.upsert.form.items.quantity.placeholder`)}
                                    onChange={(e) =>
                                      field.onChange(
                              ...
                              <FormItem>
                                <FormControl>
                                  <BetterInput
                                    ...
                                    type="number"
                                    step="0.01"
                                    placeholder={t(`quotes.upsert.form.items.unitPrice.placeholder`)}
                                    onChange={(e) =>
                                      field.onChange(
                                        e.target.value === "" ? undefined : Number(e.target.value),
                                      )
