...
function getQuoteActions(
  ...
  switch (currentStep.key) {
    case "draft":
      return handlers.onSend ? [{ action: "send", label: "quotes.progression.actions.send" }] : []
    case "sent":
      return handlers.onResend ? [{ action: "resend", label: "quotes.progression.actions.resend" }] : []
    case "signed":
    ...
    <>
      ...
      <AlertDialog open={!!confirmDialog} onOpenChange={() => setConfirmDialog(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {confirmDialog && t(`quotes.progression.confirmations.${confirmDialog.action}.title`)}
            </AlertDialogTitle>
            <AlertDialogDescription>
              {confirmDialog &&
                t(`quotes.progression.confirmations.${confirmDialog.action}.description`, {
                  number: quoteLabel,
                  client: clientName,
                })}
            </AlertDialogDescription>
