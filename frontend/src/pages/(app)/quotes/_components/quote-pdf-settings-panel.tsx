                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="space-y-2">
                                ...
                                <Select value={settings.fontFamily} onValueChange={(value) => updateField("fontFamily", value)}>
                                    <SelectTrigger>
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {LABEL_FIELDS.map(({ key, i18nKey }) => (
                                    <div className="space-y-2" key={key}>
                                        <Label htmlFor={`quote-label-${key}`}>{t(`settings.pdfTemplates.labels.${i18nKey}`)}</Label>
                                        <Input
                                            id={`quote-label-${key}`}
