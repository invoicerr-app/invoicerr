...
export function QuoteTable() {
  ...
  const { handleExport } = useTableExport(
    ...
    [
      {
        header: t("quotes.table.columns.number"),
        cell: (quote) => quote.rawNumber || (quote.number?.toString() ?? ""),
      },
      ...
      {
        header: t("quotes.table.columns.createdAt"),
        cell: (quote) => new Date(quote.createdAt).toLocaleDateString(),
      },
      {
        header: t("quotes.table.columns.validUntil"),
        cell: (quote) => (quote.validUntil ? new Date(quote.validUntil).toLocaleDateString() : ""),
      },
    ],
    "quotes.csv",
  )
