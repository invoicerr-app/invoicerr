...
export function ClientUpsert({
		...
		.object({
			...
			foundedAt: z
				...
				.refine(
					...
					t("clients.upsert.validation.foundedAt.future"),
				),
			...
			address: z
				.string()
				.min(1, t("clients.upsert.validation.address.required")),
			...
			country: z
				.string()
				.min(1, t("clients.upsert.validation.country.required")),
		})
		.superRefine((val, ctx) => {
			if (val.type === "INDIVIDUAL") {
				...
				if (!val.legalId || val.legalId.trim() === "") {
					ctx.addIssue({
						...
						path: ["legalId"],
						message:
							t("clients.upsert.validation.legalId.required") ||
							"SIRET is required for companies",
					});
				}
			}
		});
	...
	useEffect(() => {
		if (isEditing && client) {
			const c = client;
			form.reset({
				type: (c.type as "INDIVIDUAL" | "COMPANY") || "COMPANY",
				name: c.name || "",
		...
		>
			...
			>
				<div className="flex-1 overflow-auto">
					<DialogHeader>
						<DialogTitle>
							{t(`clients.upsert.title.${isEditing ? "edit" : "create"}`)}
						</DialogTitle>
					</DialogHeader>
					<Form {...form}>
						<form
						...
						>
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel>
											{t("clients.upsert.fields.type.label") || "Client type"}
										</FormLabel>
										<FormControl>
											<Select
							...
							{clientType === "COMPANY" ? (
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel>
												{t("clients.upsert.fields.name.label")}
											</FormLabel>
											<FormControl>
												<Input
													{...field}
													placeholder={t(
														"clients.upsert.fields.name.placeholder",
													)}
												/>
											</FormControl>
											<FormMessage />
											...
											<FormItem>
												...
												<FormControl>
													<Input
														{...field}
														placeholder={t(
															"clients.upsert.fields.contactFirstname.placeholder",
														)}
													/>
												</FormControl>
												<FormMessage />
											...
											<FormItem>
												...
												<FormControl>
													<Input
														{...field}
														placeholder={t(
															"clients.upsert.fields.contactLastname.placeholder",
														)}
													/>
												</FormControl>
												<FormMessage />
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel>
											{t("clients.upsert.fields.description.label")}
										</FormLabel>
										<FormControl>
											<Input
												{...field}
												placeholder={t(
													"clients.upsert.fields.description.placeholder",
												)}
											/>
										</FormControl>
										<FormMessage />
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												<FormLabel required>
													{t("clients.upsert.fields.legalId.label")}
												</FormLabel>
												<FormControl>
													<Input
														{...field}
														placeholder={t(
															"clients.upsert.fields.legalId.placeholder",
														)}
													/>
												</FormControl>
												<FormMessage />
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												<FormLabel>
													{t("clients.upsert.fields.vat.label")}
												</FormLabel>
												<FormControl>
													<Input
														{...field}
														placeholder={t(
															"clients.upsert.fields.vat.placeholder",
														)}
													/>
												</FormControl>
												<FormMessage />
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel>
												{t("clients.upsert.fields.currency.label")}
											</FormLabel>
											<FormControl>
												<CurrencySelect
													value={field.value}
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel>
												{t("clients.upsert.fields.foundedAt.label")}
											</FormLabel>
											<FormControl>
												<DatePicker
													className="w-full"
													...
													placeholder={t(
														"clients.upsert.fields.foundedAt.placeholder",
													)}
												/>
											</FormControl>
											<FormMessage />
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel required>
												{t("clients.upsert.fields.contactEmail.label")}
											</FormLabel>
											<FormControl>
												<Input
													{...field}
													placeholder={t(
														"clients.upsert.fields.contactEmail.placeholder",
													)}
												/>
											</FormControl>
											<FormMessage />
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel>
												{t("clients.upsert.fields.contactPhone.label")}
											</FormLabel>
											<FormControl>
												<Input
													{...field}
													placeholder={t(
														"clients.upsert.fields.contactPhone.placeholder",
													)}
												/>
											</FormControl>
											<FormMessage />
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel required>
											{t("clients.upsert.fields.address.label")}
										</FormLabel>
										<FormControl>
											<Input
												{...field}
												placeholder={t(
													"clients.upsert.fields.address.placeholder",
												)}
											/>
										</FormControl>
										<FormMessage />
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel>
											{t("clients.upsert.fields.addressLine2.label")}
										</FormLabel>
										<FormControl>
											<Input
												{...field}
												placeholder={t(
													"clients.upsert.fields.addressLine2.placeholder",
												)}
											/>
										</FormControl>
										<FormMessage />
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel required>
												{t("clients.upsert.fields.postalCode.label")}
											</FormLabel>
											<FormControl>
												<Input
													{...field}
													placeholder={t(
														"clients.upsert.fields.postalCode.placeholder",
													)}
												/>
											</FormControl>
											<FormMessage />
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel required>
												{t("clients.upsert.fields.city.label")}
											</FormLabel>
											<FormControl>
												<Input
													{...field}
													placeholder={t(
														"clients.upsert.fields.city.placeholder",
													)}
												/>
											</FormControl>
											<FormMessage />
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel>
												{t("clients.upsert.fields.state.label")}
											</FormLabel>
											<FormControl>
												<Input
													{...field}
													placeholder={t(
														"clients.upsert.fields.state.placeholder",
													)}
												/>
											</FormControl>
											<FormMessage />
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel required>
											{t("clients.upsert.fields.country.label")}
										</FormLabel>
										<FormControl>
											<Input
												{...field}
												placeholder={t(
													"clients.upsert.fields.country.placeholder",
												)}
											/>
										</FormControl>
										<FormMessage />
