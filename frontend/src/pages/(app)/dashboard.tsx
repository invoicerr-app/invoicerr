...
import { Company, Invoice, Quote } from "@/types";
										...
										<section>
											...
											<section className="flex flex-row gap-4">
												...
												<div className="flex items-center mt-2">
													{(dashboardData?.revenue.monthlyChangePercent || 0) >
													0 ? (
														<ArrowUpRight className="h-4 w-4 text-emerald-600" />
													) : (dashboardData?.revenue.monthlyChangePercent ||
															0) < 0 ? (
									...
									<section className="flex flex-row justify-between items-start">
										<section>
											...
											<section className="flex flex-row gap-4">
												...
												<div className="flex items-center mt-2">
													{(dashboardData?.revenue.yearlyChangePercent || 0) >
													0 ? (
														<ArrowUpRight className="h-4 w-4 text-emerald-600" />
													) : (dashboardData?.revenue.yearlyChangePercent ||
															0) < 0 ? (
														<ArrowDownRight className="h-4 w-4 text-red-600" />
													) : (
														<ArrowRight className="h-4 w-4 text-gray-400" />
			...
			<section className="space-y-6">
				<div className="flex items-center space-x-3">
					...
					<div>
						...
						<p className="text-sm text-muted-foreground">
							{t("dashboard.quotes.description")}
						</p>
					</div>
				</div>
