        ...
        <div className="max-w-7xl mx-auto space-y-6 p-6">
            <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="min-w-36 text-center text-sm font-medium capitalize" data-cy="expenses-month-label">
                ...
                <div className="flex items-center gap-2">
                    <Button type="button" variant="outline" onClick={handleExport} disabled={filtered.length === 0} dataCy="expenses-export">
            ...
            <ExpenseTable expenses={filtered} onEdit={handleEdit} onDelete={setDeleteTarget} onDuplicate={handleDuplicate} />
