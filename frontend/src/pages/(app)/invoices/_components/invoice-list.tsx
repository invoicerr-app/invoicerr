                          ...
                          <div className="mt-2 flex flex-col gap-2 text-sm text-muted-foreground">
                            <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-1">
                              <span>
                                ...
                                {invoice.client.name ||
                                  invoice.client.contactFirstname +
                                    ' ' +
                                    invoice.client.contactLastname}
                              </span>
                              <span>
                                <span className="font-medium text-foreground">
                                  {t('invoices.list.item.issued')}:
                                </span>{' '}
                                {new Date(invoice.createdAt).toLocaleDateString()}
                              </span>
                              <span>
                                <span className="font-medium text-foreground">
                                  {t('invoices.list.item.due')}:
                                </span>{' '}
                              ...
                              {invoice.paymentMethod && (
                                <span>
                                  ...
                                  {(invoice.paymentMethod as any)?.name ??
                                    (invoice.paymentMethod as any)?.type ??
                                    '-'}
                                </span>
                              )}
                              <span>
                                <span className="font-medium text-foreground">
                                  {t('invoices.list.item.totalHT')}:
                                </span>{' '}
                      ...
                      <div className="grid grid-cols-2 lg:flex justify-start sm:justify-end gap-1 md:gap-2">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="center" className="[&>*]:cursor-pointer w-48">
                            ...
                            <DropdownMenuItem
                              onClick={() =>
                                handleDownload({ invoice, format: '', file_format: 'pdf' })
                              }
                            >
                              Standard
                            </DropdownMenuItem>
                            <DropdownMenuItem
                              onClick={() =>
                                handleDownload({ invoice, format: 'facturx', file_format: 'pdf' })
                              }
                            >
                              Factur-X
                            </DropdownMenuItem>
                            <DropdownMenuItem
                              onClick={() =>
                                handleDownload({ invoice, format: 'zugferd', file_format: 'pdf' })
                              }
                            >
                              ZUGFeRD
                            </DropdownMenuItem>
                            <DropdownMenuItem
                              onClick={() =>
                                handleDownload({ invoice, format: 'xrechnung', file_format: 'pdf' })
                              }
                            >
                              XRechnung
                            </DropdownMenuItem>
                            <DropdownMenuItem
                              onClick={() =>
                                handleDownload({ invoice, format: 'ubl', file_format: 'pdf' })
                              }
                            >
                              UBL
                            </DropdownMenuItem>
                            <DropdownMenuItem
                              onClick={() =>
                                handleDownload({ invoice, format: 'cii', file_format: 'pdf' })
                              }
                            >
                              CII
                            </DropdownMenuItem>
                            ...
                            <DropdownMenuItem
                              onClick={() =>
                                handleDownload({ invoice, format: 'facturx', file_format: 'xml' })
                              }
                            >
                              Factur-X
                            </DropdownMenuItem>
                            <DropdownMenuItem
                              onClick={() =>
                                handleDownload({ invoice, format: 'zugferd', file_format: 'xml' })
                              }
                            >
                              ZUGFeRD
                            </DropdownMenuItem>
                            <DropdownMenuItem
                              onClick={() =>
                                handleDownload({ invoice, format: 'xrechnung', file_format: 'xml' })
                              }
                            >
                              XRechnung
                            </DropdownMenuItem>
                            <DropdownMenuItem
                              onClick={() =>
                                handleDownload({ invoice, format: 'ubl', file_format: 'xml' })
                              }
                            >
                              UBL
                            </DropdownMenuItem>
                            <DropdownMenuItem
                              onClick={() =>
                                handleDownload({ invoice, format: 'cii', file_format: 'xml' })
                              }
                            >
                              CII
                            </DropdownMenuItem>
