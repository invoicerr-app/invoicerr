  ...
  useEffect(() => {
    if (isEdit && recurringInvoice) {
      form.reset({
        ...
        paymentMethodId:
          (recurringInvoice.paymentMethodId ?? recurringInvoice.paymentMethod?.id) || '',
    ...
    <>
      <Dialog open={open} onOpenChange={handleClose}>
        ...
        >
          <DialogHeader>
            <DialogTitle>
              {t(`recurringInvoices.upsert.title.${isEdit ? 'edit' : 'create'}`)}
            </DialogTitle>
          </DialogHeader>
          <Form {...form}>
            <form
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <SearchSelect
                        ...
                        noResultsComponent={
                          <Button variant="link" onClick={() => setClientDialogOpen(true)}>
                                    ...
                                    >
                                      ...
                                      <SelectContent>
                                        <SelectItem value="HOUR">
                                          {t('recurringInvoices.upsert.form.items.type.hour')}
                                        </SelectItem>
                                        <SelectItem value="DAY">
                                          {t('recurringInvoices.upsert.form.items.type.day')}
                                        </SelectItem>
                                        <SelectItem value="DEPOSIT">
                                          {t('recurringInvoices.upsert.form.items.type.deposit')}
                                        </SelectItem>
                                        <SelectItem value="SERVICE">
                                          {t('recurringInvoices.upsert.form.items.type.service')}
                                        </SelectItem>
                                        <SelectItem value="PRODUCT">
                                          {t('recurringInvoices.upsert.form.items.type.product')}
                                        </SelectItem>
                                      </SelectContent>
                                    </Select>
                                  </FormControl>
