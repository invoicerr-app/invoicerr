...
export function InvoiceTable() {
    ...
    const { handleExport } = useTableExport(rows, [
        { header: t("invoices.table.columns.number"), cell: (invoice) => invoice.rawNumber || (invoice.number?.toString() ?? "") },
        ...
        { header: t("invoices.table.columns.createdAt"), cell: (invoice) => new Date(invoice.createdAt).toLocaleDateString() },
        { header: t("invoices.table.columns.dueDate"), cell: (invoice) => invoice.dueDate ? new Date(invoice.dueDate).toLocaleDateString() : "" },
    ], "invoices.csv")
