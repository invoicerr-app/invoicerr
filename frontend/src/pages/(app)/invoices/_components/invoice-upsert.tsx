...
import { Client, Invoice, PaymentMethod, Quote } from "@/types";
import {
	type InvoiceItem,
		...
		items: z.array(
			z.object({
				...
				description: z
					...
					.refine((val) => val !== "", {
						message: t(
							"invoices.upsert.form.items.description.errors.required",
						),
					}),
				quantity: z
					.number({
						invalid_type_error: t(
							"invoices.upsert.form.items.quantity.errors.required",
						),
					})
				...
				unitPrice: z
					.number({
						invalid_type_error: t(
							"invoices.upsert.form.items.unitPrice.errors.required",
						),
					})
				...
				vatRate: z
					.number({
						invalid_type_error: t(
							"invoices.upsert.form.items.vatRate.errors.required",
						),
					})
					.min(0, t("invoices.upsert.form.items.vatRate.errors.min")),
				type: z
					.enum(["HOUR", "DAY", "DEPOSIT", "SERVICE", "PRODUCT"])
					.optional(),
				order: z.number(),
			}),
		),
	...
	useEffect(() => {
		if (isEdit && invoice) {
			...
			form.reset({
				...
				items: (inv.items || [])
					.sort((a: InvoiceItem, b: InvoiceItem) => a.order - b.order)
						...
						>
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel>
											{t("invoices.upsert.form.quote.label")}
										</FormLabel>
										<FormControl>
											<SearchSelect
												...
												placeholder={t(
													"invoices.upsert.form.quote.placeholder",
												)}
											/>
										</FormControl>
										<FormMessage />
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel required>
											{t("invoices.upsert.form.client.label")}
										</FormLabel>
										<FormControl>
											<SearchSelect
												...
												placeholder={t(
													"invoices.upsert.form.client.placeholder",
												)}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel>
											{t("invoices.upsert.form.currency.label")}
										</FormLabel>
										<FormControl>
											<CurrencySelect
												value={field.value}
												onChange={(value) => field.onChange(value)}
												data-cy="invoice-currency-select"
											/>
										</FormControl>
										<FormMessage />
									</FormItem>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel>
											{t("invoices.upsert.form.dueDate.label")}
										</FormLabel>
										<FormControl>
											<DatePicker
												className="w-full"
												...
												placeholder={t(
													"invoices.upsert.form.dueDate.placeholder",
												)}
											/>
										</FormControl>
										<FormMessage />
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel>
											{t("invoices.upsert.form.notes.label")}
										</FormLabel>
										<FormControl>
											<Textarea
												{...field}
												placeholder={t(
													"invoices.upsert.form.notes.placeholder",
												)}
												className="max-h-40"
											/>
										</FormControl>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel>
											{t("invoices.upsert.form.paymentMethod.label")}
										</FormLabel>
										<FormControl>
											<Select
												value={field.value ?? ""}
											...
											>
												<SelectTrigger
													...
													aria-label={
														t(
															"invoices.upsert.form.paymentMethod.label",
														) as string
													}
												>
													<SelectValue
														placeholder={t(
															"invoices.upsert.form.paymentMethod.placeholder",
														)}
													/>
												</SelectTrigger>
												<SelectContent>
																	...
																	<FormControl>
																		...
																		>
																			<SelectTrigger
																				...
																				aria-label={
																					t(
																						"invoices.upsert.form.items.type.label",
																					) as string
																				}
																			>
																				<SelectValue />
																			...
																			<SelectContent>
																				<SelectItem value="HOUR">
																					{t(
																						"invoices.upsert.form.items.type.hour",
																					)}
																				</SelectItem>
																				<SelectItem value="DAY">
																					{t(
																						"invoices.upsert.form.items.type.day",
																					)}
																				</SelectItem>
																				<SelectItem value="DEPOSIT">
																					{t(
																						"invoices.upsert.form.items.type.deposit",
																					)}
																				</SelectItem>
																				<SelectItem value="SERVICE">
																					{t(
																						"invoices.upsert.form.items.type.service",
																					)}
																				</SelectItem>
																				<SelectItem value="PRODUCT">
																					{t(
																						"invoices.upsert.form.items.type.product",
																					)}
																				</SelectItem>
																			</SelectContent>
																		</Select>
																...
																<FormItem>
																	<FormControl>
																		<BetterInput
																			...
																			postAdornment={t(
																				`invoices.upsert.form.items.quantity.unit`,
																			)}
																			type="number"
																			step="0.001"
																			placeholder={t(
