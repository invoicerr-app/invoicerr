...
When you have no clients yet, the page shows a *"No clients yet"* message with an **Add New** button. Add your first client here, then head to [Payment Methods](payment-methods.md).
