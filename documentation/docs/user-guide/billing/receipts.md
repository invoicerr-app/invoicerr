...
The **Receipts** page lets you issue proof-of-payment documents. Receipts are created from existing [invoices](invoices.md), so every receipt is linked to a specific invoice.
