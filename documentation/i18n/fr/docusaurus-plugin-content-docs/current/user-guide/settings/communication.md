...
L'envoi des e-mails lui-même (SMTP ou Resend) se configure au niveau de l'instance via des variables d'environnement, pas depuis cette page. Voir [Installation Docker](../../getting-started/docker-installation.md#envoi-des-e-mails).
:::
