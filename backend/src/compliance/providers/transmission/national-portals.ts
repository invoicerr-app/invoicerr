...
import { SMALL_AFRICA_PROVIDERS } from './portal-registry';
import { IdCoretaxTransmissionProvider } from './id-coretax-transmission';
import { InIrpTransmissionProvider } from './in-irp-transmission';
import { MyInvoisTransmissionProvider } from './myinvois-transmission';
import { SMALL_ASIA_PROVIDERS } from './portal-registry';
import { AnafTransmissionProvider } from './anaf-transmission';
import { ChorusProTransmissionProvider } from './choruspro-transmission';
import { EUROPE_PORTAL_PROVIDERS } from './portal-registry';
import { FaceTransmissionProvider } from './face-transmission';
import { AfipTransmissionProvider } from './afip-transmission';
import { DianTransmissionProvider } from './dian-client';
import { SefazTransmissionProvider } from './sefaz-transmission';
import { SiiTransmissionProvider } from './sii-transmission';
import { SMALL_LATAM_PROVIDERS } from './portal-registry';
import { SriTransmissionProvider } from './sri-transmission';
import { UyDgiTransmissionProvider } from './uy-dgi-transmission';
import { EgEtaTransmissionProvider } from './eg-eta-transmission';
import { GibTransmissionProvider } from './gib-transmission';
import { SMALL_MENA_PROVIDERS } from './portal-registry';
