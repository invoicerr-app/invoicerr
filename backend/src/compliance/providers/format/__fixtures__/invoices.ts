...
export const DE_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'SaaS licence mensuelle', quantity: 12, unitPrice: 99.9, vatRate: 19, type: 'SERVICE' }],
  },
  formats: {
    ubl: { valid: true },
    cii: { valid: true, xmlOnly: true },
...
export const EU_B2B_REVERSE_CHARGE: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'Conseil transfrontalier', quantity: 5, unitPrice: 1500, vatRate: 0, type: 'SERVICE' }],
  },
  formats: {
    ubl: { valid: true },
    cii: { valid: true, xmlOnly: true },
...
export const IT_ESENTE: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'Prestazione esente art.10', quantity: 1, unitPrice: 5000, vatRate: 0, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const MX_B2B: FormatFixture = {
  ...
  data: {
    ...
    company: {
      ...
      postalCode: '06000',
      country: 'Mexico',
      partyIdentifiers: [{ scheme: 'VAT', value: 'TST101010100' }],
    },
    client: {
      type: 'COMPANY',
      ...
      postalCode: '44100',
      country: 'Mexico',
      partyIdentifiers: [{ scheme: 'VAT', value: 'LOP8501011A9' }],
    },
    items: [
...
export const SA_B2B: FormatFixture = {
  ...
  data: {
    ...
    company: {
      ...
      partyIdentifiers: [{ scheme: 'VAT', value: '310123456700003' }],
    },
    client: {
      type: 'COMPANY',
      ...
      postalCode: '12211',
      country: 'Saudi Arabia',
      partyIdentifiers: [{ scheme: 'VAT', value: '310987654300003' }],
    },
    items: [
      {
        name: 'استشارات تقنية (Technical consulting)',
        quantity: 15,
        unitPrice: 500,
        vatRate: 15,
        type: 'SERVICE',
...
export const PL_B2B_EXEMPT: FormatFixture = {
  ...
  data: {
    ...
    items: [
      {
        name: 'Usługa eksportowa (Export service)',
        quantity: 1,
        unitPrice: 5000,
        vatRate: 0,
        type: 'SERVICE',
...
export const CL_B2B: FormatFixture = {
  ...
  data: {
    ...
    company: {
      ...
      postalCode: '7500000',
      country: 'Chile',
      partyIdentifiers: [{ scheme: 'VAT', value: '76123456-7' }],
    },
    client: {
      type: 'COMPANY',
      ...
      postalCode: '7500001',
      country: 'Chile',
      partyIdentifiers: [{ scheme: 'VAT', value: '87654321-0' }],
    },
    items: [
...
export const AR_B2B: FormatFixture = {
  ...
  data: {
    ...
    company: {
      ...
      postalCode: 'C1043',
      country: 'Argentina',
      partyIdentifiers: [{ scheme: 'VAT', value: '30-71234567-9' }],
    },
    client: {
      type: 'COMPANY',
      ...
      postalCode: 'C1123',
      country: 'Argentina',
      partyIdentifiers: [{ scheme: 'VAT', value: '30-98765432-1' }],
    },
    items: [
...
export const EC_B2B: FormatFixture = {
  ...
  data: {
    ...
    company: {
      ...
      postalCode: '170135',
      country: 'Ecuador',
      partyIdentifiers: [{ scheme: 'VAT', value: '1792345678001' }],
    },
    client: {
      type: 'COMPANY',
      ...
      postalCode: '170201',
      country: 'Ecuador',
      partyIdentifiers: [{ scheme: 'VAT', value: '1798765432001' }],
    },
    items: [
...
export const BR_B2B: FormatFixture = {
  ...
  data: {
    ...
    company: {
      ...
      country: 'Brazil',
      partyIdentifiers: [{ scheme: 'VAT', value: '12.345.678/0001-90' }],
    },
    client: {
      type: 'COMPANY',
      ...
      country: 'Brazil',
      partyIdentifiers: [{ scheme: 'VAT', value: '98.765.432/0001-10' }],
    },
    items: [
...
export const TR_B2B: FormatFixture = {
  ...
  data: {
    ...
    company: {
      ...
      postalCode: '34000',
      country: 'Turkey',
      partyIdentifiers: [{ scheme: 'VAT', value: '1234567890' }],
    },
    client: {
      type: 'COMPANY',
...
export const IN_B2B: FormatFixture = {
  ...
  data: {
    ...
    company: {
      ...
      postalCode: '122001',
      country: 'India',
      partyIdentifiers: [{ scheme: 'VAT', value: '06AABCT1234F1Z5' }],
    },
    client: {
      type: 'COMPANY',
      ...
      postalCode: '400001',
      country: 'India',
      partyIdentifiers: [{ scheme: 'VAT', value: '27AAACG9876E1Z9' }],
    },
    items: [
...
export const GR_B2B: FormatFixture = {
  ...
  data: {
    ...
    company: {
      ...
      postalCode: '11737',
      country: 'Greece',
      partyIdentifiers: [{ scheme: 'VAT', value: 'EL801234567' }],
    },
    client: {
      type: 'COMPANY',
      ...
      postalCode: '10557',
      country: 'Greece',
      partyIdentifiers: [{ scheme: 'VAT', value: 'EL987654321' }],
    },
    items: [
...
export const HU_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [
      {
        name: 'Szoftverfejlesztés (Software dev)',
        quantity: 100,
        unitPrice: 15000,
        vatRate: 27,
        type: 'SERVICE',
...
export const CN_B2B: FormatFixture = {
  ...
  data: {
    ...
    company: {
      ...
      postalCode: '100022',
      country: 'China',
      partyIdentifiers: [{ scheme: 'VAT', value: '91110000MA01XXXXX' }],
    },
    client: {
      type: 'COMPANY',
      name: '上海贸易有限公司',
      ...
      postalCode: '200120',
      country: 'China',
      partyIdentifiers: [{ scheme: 'VAT', value: '91310000MA01YYYYY' }],
    },
    items: [
...
export const EG_B2B: FormatFixture = {
  ...
  data: {
    ...
    company: {
      ...
      postalCode: '11835',
      country: 'Egypt',
      partyIdentifiers: [{ scheme: 'VAT', value: 'EG-123456789' }],
    },
    client: {
      type: 'COMPANY',
      ...
      postalCode: '21599',
      country: 'Egypt',
      partyIdentifiers: [{ scheme: 'VAT', value: 'EG-987654321' }],
    },
    items: [
...
export const GT_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'Consultoría de sistemas', quantity: 40, unitPrice: 800, vatRate: 12, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const PA_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'Servicios de TI', quantity: 15, unitPrice: 2500, vatRate: 7, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const SV_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'Desarrollo de software', quantity: 100, unitPrice: 50, vatRate: 13, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const VE_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'Servicios técnicos', quantity: 25, unitPrice: 500, vatRate: 16, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const BO_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'Consultoría de sistemas', quantity: 10, unitPrice: 5000, vatRate: 13, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const ID_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [
      {
        name: 'Jasa pengembangan perangkat lunak',
        quantity: 100,
        unitPrice: 500000,
        vatRate: 11,
        type: 'SERVICE',
...
export const TW_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: '軟體開發服務', quantity: 50, unitPrice: 20000, vatRate: 5, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const TH_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'Software development', quantity: 80, unitPrice: 5000, vatRate: 7, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const NP_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'IT consultancy', quantity: 20, unitPrice: 10000, vatRate: 13, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const BD_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'Software services', quantity: 10, unitPrice: 50000, vatRate: 15, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const PK_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'Software development', quantity: 100, unitPrice: 8000, vatRate: 18, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const GH_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'IT consultancy', quantity: 20, unitPrice: 5000, vatRate: 12.5, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const RW_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'Software license', quantity: 5, unitPrice: 200000, vatRate: 18, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const TN_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'Software development', quantity: 10, unitPrice: 1200, vatRate: 19, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const UA_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'IT consulting', quantity: 8, unitPrice: 50000, vatRate: 20, type: 'SERVICE' }],
  },
  formats: {},
};
...
export const ME_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'Software license', quantity: 3, unitPrice: 1500, vatRate: 21, type: 'PRODUCT' }],
  },
  formats: {},
};
...
export const AL_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [{ name: 'IT services', quantity: 6, unitPrice: 50000, vatRate: 20, type: 'SERVICE' }],
  },
  formats: {},
};
