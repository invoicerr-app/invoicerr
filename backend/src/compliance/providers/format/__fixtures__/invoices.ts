...
export const FR_B2B_STANDARD: FormatFixture = {
  ...
  data: {
    ...
    items: [
      ...
      { name: 'Formation équipe', quantity: 2, unitPrice: 800, vatRate: 20, vatCategory: 'S', type: 'HOUR' },
    ],
  },
  formats: {
    ubl: { valid: true },
...
export const FR_B2B_MULTI_VAT: FormatFixture = {
  ...
  data: {
    ...
    items: [
      ...
      { name: 'Documentation', quantity: 1, unitPrice: 30, vatRate: 5.5, vatCategory: 'S', type: 'PRODUCT' },
    ],
  },
  formats: {
    ubl: { valid: true },
...
export const B2C_INDIVIDUAL: FormatFixture = {
  ...
  data: {
    ...
    items: [
      ...
      {
        name: 'Support prioritaire (3 mois)',
        quantity: 1,
        unitPrice: 49,
        vatRate: 20,
        vatCategory: 'S',
...
export const IT_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [
      ...
      { name: 'Assistenza remota', quantity: 5, unitPrice: 80, vatRate: 22, vatCategory: 'S', type: 'HOUR' },
    ],
  },
  formats: {
...
export const IT_MULTI_VAT: FormatFixture = {
  ...
  data: {
    ...
    items: [
      ...
      { name: 'Assistenza remota', quantity: 5, unitPrice: 80, vatRate: 10, vatCategory: 'S', type: 'HOUR' },
      {
...
export const IT_ESENTE: FormatFixture = {
  ...
  data: {
    ...
    items: [
      {
        name: 'Prestazione esente art.10',
        quantity: 1,
        unitPrice: 5000,
        vatRate: 0,
        vatCategory: 'E',
...
export const PL_B2B_MULTI_VAT: FormatFixture = {
  ...
  data: {
    ...
    items: [
      ...
      {
        name: 'Wsparcie techniczne (Support)',
        quantity: 10,
        unitPrice: 100,
        vatRate: 8,
        vatCategory: 'S',
      ...
      {
        name: 'Dokumentacja (Documentation)',
        quantity: 2,
        unitPrice: 50,
        vatRate: 5,
        vatCategory: 'S',
    ...
    items: [
      {
        ...
        unitPrice: 5000,
        vatRate: 0,
        // The fixture is named PL_B2B_EXEMPT and the line is an exempt supply: category E, which
        // requires the seller identifier the Polish company carries. Not O — O would forbid that
        // identifier (BR-O-02) and change what the fixture is about.
        vatCategory: 'E',
        type: 'SERVICE',
      },
    ],
...
export const PL_B2C: FormatFixture = {
  ...
  data: {
    ...
    items: [
      {
        name: 'Kurs online (Online course)',
        quantity: 1,
        unitPrice: 299,
        vatRate: 23,
        vatCategory: 'S',
...
export const CN_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [
      { name: '软件开发服务', quantity: 1, unitPrice: 80000, vatRate: 13, vatCategory: 'S', type: 'SERVICE' },
      { name: '年度维护', quantity: 12, unitPrice: 5000, vatRate: 13, vatCategory: 'S', type: 'SERVICE' },
    ],
  },
  formats: {},
};
...
export const TW_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [
      { name: '軟體開發服務', quantity: 50, unitPrice: 20000, vatRate: 5, vatCategory: 'S', type: 'SERVICE' },
    ],
  },
  formats: {},
};
...
export const KE_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [
      ...
      { name: 'Training', quantity: 5, unitPrice: 20000, vatRate: 16, vatCategory: 'S', type: 'SERVICE' },
    ],
  },
  formats: {},
};
...
export const HR_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [
      { name: 'IT consulting', quantity: 10, unitPrice: 800, vatRate: 25, vatCategory: 'S', type: 'SERVICE' },
      { name: 'Hardware', quantity: 2, unitPrice: 1200, vatRate: 25, vatCategory: 'S', type: 'PRODUCT' },
    ],
  },
  formats: {},
};
...
export const AL_B2B: FormatFixture = {
  ...
  data: {
    ...
    items: [
      { name: 'IT services', quantity: 6, unitPrice: 50000, vatRate: 20, vatCategory: 'S', type: 'SERVICE' },
    ],
  },
  formats: {},
};
