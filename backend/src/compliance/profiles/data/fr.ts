...
export const FR: CountryComplianceProfile = {
  ...
  regime: [
    ...
    { validFrom: '1900-01-01', validTo: '2026-09-01', value: { model: 'POST_AUDIT', blocking: false } },
  ...
  formats: [
    {
      ...
      value: {
        primary: { syntax: 'FACTURX' }, // hybrid PDF/A-3 + CII — already produced by @fin.cx/einvoice
        human: { syntax: 'PDF_A3' },
  ...
  transmission: [
    { validFrom: '1900-01-01', validTo: '2026-09-01', value: { channels: [{ type: 'EMAIL' }] } },
    {
      validFrom: '2026-09-01',
      value: { channels: [{ type: 'PDP' }, { type: 'PEPPOL' }, { type: 'EMAIL' }] },
    },
  ],
  ...
  archival: [
    {
      validFrom: '1900-01-01',
      value: { retentionYears: 10, archivedForm: 'BOTH', integrity: 'HASH_CHAIN' },
    },
  ],
