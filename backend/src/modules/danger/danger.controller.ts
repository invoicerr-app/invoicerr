...
export class DangerController {
  ...
  @ApiOperation({
    ...
    description: 'Deletes all documents (invoices, quotes, payments) while preserving company configuration.',
  })
  @ApiQuery({
    name: 'otp',
    required: true,
  ...
  @ApiOperation({
    ...
    description:
      'Deletes all data including documents, clients, and company configuration. The app returns to its initial state.',
  })
  @ApiQuery({
    name: 'otp',
    required: true,
