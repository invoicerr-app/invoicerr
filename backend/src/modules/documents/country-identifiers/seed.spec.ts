...
describe('seedCountryIdentifierRequirements', () => {
  ...
  // The known gap ("country-identifiers/seed.ts never purges a country that has been
  // entirely removed"): a country ENTIRELY removed from the catalog (not just one of
