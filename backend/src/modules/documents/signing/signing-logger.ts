/**
 * Tiny, dependency-free logger for the signing providers — reprised verbatim from the reference's
 ...
 * unit-testable without booting Nest — the same reasoning the reference's own header gave, still true
