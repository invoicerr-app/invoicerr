 ...
 * NullTsaClient: offline-safe default (returns null; never calls the network) — the default this
 *                module's registry uses everywhere except a real TSA_URL.
 ...
 *
 * buildTsq / extractTokenFromTsr are exported for unit-test coverage (tsa-client.spec.ts).
 */
