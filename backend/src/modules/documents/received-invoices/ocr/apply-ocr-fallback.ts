 ...
 * ("OCR for unstructured received PDFs"). A structured deposit (CII/UBL/Factur-X) never reaches this
 ...
 *    only ever needs to say "no OCR available, fill in by hand" — an honest absence, never a
 *    silent failure, never a distinction the user could
