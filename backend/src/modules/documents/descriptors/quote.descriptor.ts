 ...
 * quantity, unit price). Actions: save the draft (implemented, see actions/quote-actions.ts) and
 * send (declared, deliberately NOT implemented — see documents.module.ts for why).
 */
