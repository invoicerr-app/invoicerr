...
import {
    buildClDte, buildArFe, buildEcFe, buildBrNfe, buildCrFe, buildDoEcf, buildGtFel,
    buildPaFe, buildPyDe, buildSvDte, buildUyCfe, buildVeFe, buildBoFe,
} from './latam-builders';
import {
    buildCnEfapiao, buildInIrp, buildIdEfaktur, buildTwEgui, buildKzEsf, buildPhEis,
    buildThEtax, buildNpCbms, buildBdNbr, buildPkFbr, buildVnTt78, buildMyInvois,
} from './asia-builders';
import { buildTrEfatura, buildEgEta, buildJoJofotara, buildTnTeif } from './mena-builders';
import {
    buildGrMydata, buildHuSzM, buildUaTaxinvoice, buildMeFiscal, buildHrEracun,
    buildAlFiscalization,
} from './europe-builders';
import {
    buildNgFirs, buildKeEtims, buildGhEvat, buildRwEbm, buildTzVfd, buildUgEfris,
