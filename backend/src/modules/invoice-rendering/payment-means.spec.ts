 ...
 */
import { InvoiceRenderingService, mapPaymentMeansCode, extractIban, InvoiceRenderData } from './invoice-rendering.service';
...
describe('mapPaymentMeansCode', () => {
  ...
  it('maps PAYPAL to 97 (clearing between partners)', () => {
    expect(mapPaymentMeansCode('PAYPAL')).toBe(97);
  });

  it('maps CARD to 97', () => {
    expect(mapPaymentMeansCode('CARD')).toBe(97);
  });
