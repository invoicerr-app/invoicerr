...
export const EVENT_STYLES: Record<WebhookEvent, EventStyle> = {
	...
	[WebhookEvent.QUOTE_DELETED]: {
		color: "#ef4444",
		emoji: "🗑️",
		title: "Quote Deleted",
	},
	[WebhookEvent.QUOTE_SENT]: {
		color: "#10b981",
		emoji: "📤",
		title: "Quote Sent",
	},
	[WebhookEvent.QUOTE_SIGNED]: {
		color: "#10b981",
		emoji: "✅",
		title: "Quote Signed",
	},
	...
	[WebhookEvent.QUOTE_VIEWED]: {
		color: "#8b5cf6",
		emoji: "👁️",
		title: "Quote Viewed",
	},
	[WebhookEvent.QUOTE_MARKED_AS_SIGNED]: {
		color: "#10b981",
		emoji: "✍️",
		title: "Quote Marked as Signed",
	},
	[WebhookEvent.QUOTE_PDF_GENERATED]: {
		color: "#6366f1",
		emoji: "📄",
		title: "Quote PDF Generated",
	},
	[WebhookEvent.QUOTE_SEARCHED]: {
		color: "#6b7280",
		emoji: "🔍",
		title: "Quote Searched",
	},
	[WebhookEvent.QUOTE_STATUS_CHANGED]: {
		color: "#3b82f6",
		emoji: "🔄",
	...
	[WebhookEvent.INVOICE_MARKED_AS_PAID]: {
		color: "#10b981",
		emoji: "✅",
		title: "Invoice Marked as Paid",
	},
	[WebhookEvent.INVOICE_PDF_GENERATED]: {
		color: "#6366f1",
		emoji: "📄",
		title: "Invoice PDF Generated",
	},
	[WebhookEvent.INVOICE_XML_DOWNLOADED]: {
		color: "#6366f1",
		emoji: "📥",
		title: "Invoice XML Downloaded",
	},
	...
	[WebhookEvent.INVOICE_SEARCHED]: {
		color: "#6b7280",
		emoji: "🔍",
		title: "Invoice Searched",
	},
	...
	[WebhookEvent.RECEIPT_CREATED]: {
		color: "#8b5cf6",
		emoji: "🧾",
		title: "Receipt Created",
	},
	[WebhookEvent.RECEIPT_UPDATED]: {
		color: "#8b5cf6",
		emoji: "✏️",
		title: "Receipt Updated",
	},
	[WebhookEvent.RECEIPT_DELETED]: {
		color: "#ef4444",
		emoji: "🗑️",
		title: "Receipt Deleted",
	},
	[WebhookEvent.RECEIPT_SENT]: {
		color: "#8b5cf6",
		emoji: "📧",
		title: "Receipt Sent",
	},
	[WebhookEvent.RECEIPT_PDF_GENERATED]: {
		color: "#6366f1",
		emoji: "📄",
	...
	[WebhookEvent.RECEIPT_SEARCHED]: {
		color: "#6b7280",
		emoji: "🔍",
		title: "Receipt Searched",
	},
	...
	[WebhookEvent.PAYMENT_METHOD_CREATED]: {
		color: "#f59e0b",
		emoji: "➕",
		title: "Payment Method Created",
	},
	[WebhookEvent.PAYMENT_METHOD_UPDATED]: {
		color: "#f59e0b",
		emoji: "✏️",
	...
	[WebhookEvent.SIGNATURE_COMPLETED]: {
		color: "#10b981",
		emoji: "✅",
		title: "Signature Completed",
	},
	[WebhookEvent.SIGNATURE_EXPIRED]: {
		color: "#f59e0b",
		emoji: "⏰",
		title: "Signature Expired",
	},
	[WebhookEvent.SIGNATURE_OTP_GENERATED]: {
		color: "#14b8a6",
		emoji: "🔐",
		title: "Signature OTP Generated",
	},
	[WebhookEvent.SIGNATURE_OTP_SENT]: {
		color: "#14b8a6",
		emoji: "📧",
		title: "Signature OTP Sent",
	},
	[WebhookEvent.SIGNATURE_VIEWED]: {
		color: "#8b5cf6",
		emoji: "👁️",
		title: "Signature Viewed",
	},
	[WebhookEvent.SIGNATURE_EMAIL_SENT]: {
		color: "#14b8a6",
		emoji: "📧",
		title: "Signature Email Sent",
	},
	...
	[WebhookEvent.CLIENT_ACTIVATED]: {
		color: "#10b981",
		emoji: "✅",
		title: "Client Activated",
	},
	[WebhookEvent.CLIENT_DEACTIVATED]: {
		color: "#6b7280",
		emoji: "⏸️",
		title: "Client Deactivated",
	},
	[WebhookEvent.CLIENT_SEARCHED]: {
		color: "#6b7280",
		emoji: "🔍",
		title: "Client Searched",
	},

	// Company events - Orange
	[WebhookEvent.COMPANY_CREATED]: {
		color: "#f97316",
		emoji: "🏢",
		title: "Company Created",
	},
	[WebhookEvent.COMPANY_UPDATED]: {
		color: "#f97316",
		emoji: "✏️",
		title: "Company Updated",
	},
	[WebhookEvent.COMPANY_PDF_CONFIG_UPDATED]: {
		color: "#f97316",
		emoji: "⚙️",
		title: "PDF Config Updated",
	},
	...
	[WebhookEvent.COMPANY_INFO_VIEWED]: {
		color: "#6b7280",
		emoji: "👁️",
	...
	[WebhookEvent.PLUGIN_DEACTIVATED]: {
		color: "#6b7280",
		emoji: "⏸️",
		title: "Plugin Deactivated",
	},
	[WebhookEvent.PLUGIN_CONFIGURED]: {
		color: "#6366f1",
		emoji: "⚙️",
		title: "Plugin Configured",
	},
	[WebhookEvent.PLUGIN_ADDED]: {
		color: "#10b981",
		emoji: "➕",
		title: "Plugin Added",
	},
	[WebhookEvent.PLUGIN_REMOVED]: {
		color: "#ef4444",
		emoji: "➖",
		title: "Plugin Removed",
	},
	[WebhookEvent.PLUGIN_VALIDATED]: {
		color: "#10b981",
		emoji: "✅",
		title: "Plugin Validated",
	},
	...
	[WebhookEvent.PLUGIN_FORMAT_REQUESTED]: {
		color: "#6366f1",
		emoji: "📄",
		title: "Plugin Format Requested",
	},
	[WebhookEvent.PLUGIN_WEBHOOK_RECEIVED]: {
		color: "#6366f1",
		emoji: "📥",
		title: "Plugin Webhook Received",
	},
	...
	[WebhookEvent.USER_LOGGED_IN]: {
		color: "#10b981",
		emoji: "🔓",
		title: "User Logged In",
	},
	[WebhookEvent.USER_PASSWORD_CHANGED]: {
		color: "#f59e0b",
		emoji: "🔑",
	...
	[WebhookEvent.USER_OIDC_LOGIN]: {
		color: "#10b981",
		emoji: "🔐",
		title: "OIDC Login",
	},
	[WebhookEvent.USER_OIDC_CALLBACK]: {
		color: "#6366f1",
		emoji: "🔄",
		title: "OIDC Callback",
	},
	...
	[WebhookEvent.EMAIL_TEMPLATE_UPDATED]: {
		color: "#0ea5e9",
		emoji: "✏️",
		title: "Email Template Updated",
	},
	...
	[WebhookEvent.STATS_MONTHLY_REQUESTED]: {
		color: "#6b7280",
		emoji: "📊",
		title: "Monthly Stats Requested",
	},
	[WebhookEvent.STATS_YEARLY_REQUESTED]: {
		color: "#6b7280",
		emoji: "📊",
		title: "Yearly Stats Requested",
	},
	[WebhookEvent.CURRENCY_RATE_UPDATED]: {
		color: "#f59e0b",
		emoji: "💱",
	...
	[WebhookEvent.APP_RESET]: {
		color: "#ef4444",
		emoji: "🔄",
		title: "App Reset",
	},
	[WebhookEvent.APP_ALL_DATA_RESET]: {
		color: "#ef4444",
		emoji: "⚠️",
		title: "All Data Reset",
	},
	[WebhookEvent.OTP_REQUESTED]: {
		color: "#6b7280",
		emoji: "🔐",
		title: "OTP Requested",
	},
	[WebhookEvent.OTP_VALIDATED]: {
		color: "#10b981",
		emoji: "✅",
		title: "OTP Validated",
	},
	[WebhookEvent.OTP_EXPIRED]: {
		color: "#f59e0b",
		emoji: "⏰",
		title: "OTP Expired",
	},
	...
	[WebhookEvent.WEBHOOK_UPDATED]: {
		color: "#8b5cf6",
		emoji: "✏️",
		title: "Webhook Updated",
	},
	[WebhookEvent.WEBHOOK_DELETED]: {
		color: "#ef4444",
		emoji: "🗑️",
		title: "Webhook Deleted",
	},
	[WebhookEvent.WEBHOOK_TRIGGERED]: {
		color: "#10b981",
		emoji: "🔔",
		title: "Webhook Triggered",
	},
	[WebhookEvent.WEBHOOK_FAILED]: {
		color: "#ef4444",
		emoji: "❌",
	...
	// Item events
	[WebhookEvent.QUOTE_ITEM_CREATED]: {
		color: "#3b82f6",
		emoji: "➕",
		title: "Quote Item Created",
	},
	[WebhookEvent.QUOTE_ITEM_UPDATED]: {
		color: "#3b82f6",
		emoji: "✏️",
		title: "Quote Item Updated",
	},
	[WebhookEvent.QUOTE_ITEM_DELETED]: {
		color: "#ef4444",
		emoji: "➖",
		title: "Quote Item Deleted",
	},
	[WebhookEvent.INVOICE_ITEM_CREATED]: {
		color: "#10b981",
		emoji: "➕",
		title: "Invoice Item Created",
	},
	[WebhookEvent.INVOICE_ITEM_UPDATED]: {
		color: "#10b981",
		emoji: "✏️",
		title: "Invoice Item Updated",
	},
	[WebhookEvent.INVOICE_ITEM_DELETED]: {
		color: "#ef4444",
		emoji: "➖",
		title: "Invoice Item Deleted",
	},
	[WebhookEvent.RECEIPT_ITEM_CREATED]: {
		color: "#8b5cf6",
		emoji: "➕",
		title: "Receipt Item Created",
	},
	[WebhookEvent.RECEIPT_ITEM_UPDATED]: {
		color: "#8b5cf6",
		emoji: "✏️",
		title: "Receipt Item Updated",
	},
	[WebhookEvent.RECEIPT_ITEM_DELETED]: {
		color: "#ef4444",
		emoji: "➖",
	...
	[WebhookEvent.PDF_CONFIG_CREATED]: {
		color: "#6366f1",
		emoji: "⚙️",
		title: "PDF Config Created",
	},
	[WebhookEvent.PDF_CONFIG_UPDATED]: {
		color: "#6366f1",
		emoji: "⚙️",
		title: "PDF Config Updated",
	},
	[WebhookEvent.EMAIL_TEMPLATE_CREATED]: {
		color: "#0ea5e9",
		emoji: "📧",
	...
	[WebhookEvent.QUOTE_NUMBER_GENERATED]: {
		color: "#3b82f6",
		emoji: "🔢",
		title: "Quote Number Generated",
	},
	...
	[WebhookEvent.CRON_JOB_STARTED]: {
		color: "#6b7280",
		emoji: "⏰",
		title: "Cron Job Started",
	},
	[WebhookEvent.CRON_JOB_COMPLETED]: {
		color: "#10b981",
		emoji: "✅",
		title: "Cron Job Completed",
	},
	[WebhookEvent.CRON_JOB_FAILED]: {
		color: "#ef4444",
		emoji: "❌",
	...
	[WebhookEvent.CURRENCY_RATE_FETCHED]: {
		color: "#f59e0b",
		emoji: "💱",
		title: "Currency Rate Fetched",
	},

	// Mail template events
	[WebhookEvent.MAIL_TEMPLATE_CREATED]: {
		color: "#0ea5e9",
		emoji: "📧",
		title: "Mail Template Created",
	},
	[WebhookEvent.MAIL_TEMPLATE_UPDATED]: {
		color: "#0ea5e9",
		emoji: "✏️",
	...
	[WebhookEvent.SSE_DATA_STREAMED]: {
		color: "#6b7280",
		emoji: "📡",
		title: "SSE Data Streamed",
	},

	// Validation events
	[WebhookEvent.DATA_VALIDATED]: {
		color: "#10b981",
		emoji: "✅",
		title: "Data Validated",
	},
	[WebhookEvent.CONFIGURATION_VALIDATED]: {
		color: "#10b981",
		emoji: "✅",
...
export function formatPayloadForEvent(
	event: WebhookEvent,
	payload: any,
): string {
