...
export class DirectoryController {
  ...
  @ApiOperation({
    ...
    description: 'Returns the contents of a directory at the given path.',
  })
  @ApiQuery({
    name: 'path',
    required: false,
    type: String,
    description: 'Filesystem path to list. Defaults to "/".',
  })
  ...
  @ApiOperation({
    ...
    description: 'Creates a new subdirectory at the specified path.',
  })
  @ApiBody({
    schema: {
      type: 'object',
      properties: {
        ...
        name: { type: 'string', description: 'Name of the subdirectory to create' },
      },
      required: ['path', 'name'],
    },
  })
