...
export class QuotesController {
  ...
  @ApiOperation({
    ...
    description: 'Searches quotes by query string (client name, quote number, etc.).',
  })
  @ApiQuery({
    name: 'query',
    required: true,
  ...
  @Get('table')
  @ApiOperation({
    summary: 'List quotes for table view',
    description:
      'Returns the full (unpaginated) list of quotes matching the given filters, sorted by creation date. Used by the quotes table view and its export.',
  })
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Filter quotes created during this year.',
  })
  @ApiQuery({
    name: 'month',
    required: false,
    type: String,
    description: 'Filter quotes created during this month (1-12). Ignored unless "year" is also provided.',
  })
  @ApiQuery({
    name: 'sort',
    required: false,
  ...
  @ApiOperation({
    summary: 'Get quote invoicing status',
    description:
      'Returns the remaining invoicable quantity per quote item and the overall remaining percentage, based on invoices already created from this quote.',
  })
