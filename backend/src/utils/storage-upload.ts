 ...
 */
// biome-ignore lint/complexity/noStaticOnlyClass: static singleton facade consumed as StorageUploadService.x() at 2 call sites; converting to functions is churn without benefit
